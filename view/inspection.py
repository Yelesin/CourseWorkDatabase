...
"")
        ...
        self.animal_box.setMinimumSize(QtCore.QSize(350, 40))
...
"")
    ...
    def retranslateUi(self, InspectionWindow):
        ...
        self.status_box.setItemText(2, _translate("InspectionWindow", "Списанное"))
        self.info_animal.setText(_translate("InspectionWindow", "Инфа о животном"))
        self.img_animal_1.setText(_translate("InspectionWindow", "TextLabel"))
        self.img_feed_1.setText(_translate("InspectionWindow", "TextLabel"))
        self.img_gender_1.setText(_translate("InspectionWindow", "TextLabel"))
